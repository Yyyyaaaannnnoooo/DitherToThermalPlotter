class Dither {
  ...
  private PImage dither, big, gradient;
  String kernelName = "";
  ...
  //to be improved
  //void saveHiRes(PImage img, int enlFactor) { //gets an image and enlargment factor as arguments
  //  PGraphics print = createGraphics(img.width * enlFactor, img.height * enlFactor);
  //  print.beginDraw();
  //  //print.beginRaw(print);
  //  print.noStroke();
  ...
  //      print.fill(c);
  //      print.rect(x * enlFactor, y * enlFactor, enlFactor, enlFactor);
  //    }
  //  }
  //  //print.endRaw();
  //  print.endDraw();
  //  String date = new java.text.SimpleDateFormat("yyyy_MM_dd_kkmmss").format(new java.util.Date ());
  //  print.save(date+"_"+ditherKernel+"_dither_factor_"+fac+"color_level_"+level+".png");
  //}
